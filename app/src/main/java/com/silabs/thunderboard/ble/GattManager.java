...
import static com.silabs.thunderboard.R.string.motion_acceleration_g;
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
            ...
            if (ba == null || ba.length == 0) {
                ...
                if (ThunderBoardUuids.UUID_CHARACTERISTIC_BATTERY_LEVEL.equals(uuid)) {
                    ...
                    int accelerationZ = 3000;//characteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_SINT16, 4);
                    byte[] acceleration_array = characteristic.getValue();
                    ...
                    sensor.setAcceleration(accelerationX / 1000f, accelerationY /1000f, acceleration_array);

                    //String accelerationString = getString(motion_acceleration_g);
                    //acceleration_X.setText(String.format(accelerationString, accelerationX));
